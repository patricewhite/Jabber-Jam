...
///////////////                  Imports                   /////////////////////////
///////////////////////////////////////////////////////////////////////////////////
/*Importing Mongoose and bcryptjs*/
...
chatRoomSchema.methods.apiRepr = function() {
  return {id: this._id, users: this.users, messages: this.messages, title: this.title, category: this.category};
};
...
userSchema.methods.apiRepr = function() {
  return {googleId: this.googleId, ownChatRoom: this.chatroomId};
};
